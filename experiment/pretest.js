...
/////////////// Write the MCQ below in the exactly same described format ///////////////
  ...
  const myQuestions = [
   ...
   ///// Copy below section */
    ...
    {
      question: "To do arithmetic operation we have to give two operands?.",
       answers: {
        a: "Yes",
        b: "No",
      },
      ...
      {
      question: "To do operation,it will accept floating value and integer value?",
      answers: {
        a: "Yes",
        b: "No",
      },
      ...
      {
      question: "While doing modulus operation,the remainder is integer?",
      answers: {
        a: "Yes",
        b: "No",
